...
def hosts(resources):
    ...
    for module_name, key, resource in resources:
        ...
        yield parse_ddcloud_server(resource, module_name)
...
def parse_ddcloud_server(resource, module_name):
...
def main():
    ...
    hosts = hosts(resources(get_state_files(args.root)))
    if args.list:
